...
githubapp secret
*/}}
{{- define "otelcol-github-actions.secret.githubAppName" }}
{{- printf "%s" .Values.secret.githubAppName }}
{{- end }}

{{/*
backstage secret
*/}}
{{- define "otelcol-github-actions.secret.backstage" }}
{{- printf "%s" .Values.secret.backstage }}
{{- end }}
